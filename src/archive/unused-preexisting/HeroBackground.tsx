...
export default function HeroBackground() {
  ...
  return (
    ...
    >
      ...
      <svg
        className="w-full h-full min-w-[1200px] min-h-[800px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-70"
        viewBox="0 0 1000 600"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
        {/* PARALLAX BACK LAYER: Grid & Alignment marks */}
        <g className="parallax-layer-back opacity-25">
          ...
          >
            <circle cx="2" cy="2" r="1" fill="var(--color-brand-primary)" opacity="0.22" />
          </pattern>
        ...
        <g className="parallax-layer-mid">
          ...
          <g transform="translate(180, 200)" className="opacity-30">
